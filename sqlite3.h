...
*/
SQLITE_API SQLITE_EXPERIMENTAL sqlite3_wal_replication *sqlite3_wal_replication_find(
  const char *zReplication);
SQLITE_API SQLITE_EXPERIMENTAL int sqlite3_wal_replication_register(
  sqlite3_wal_replication *pReplication, int makeDflt);
SQLITE_API SQLITE_EXPERIMENTAL int sqlite3_wal_replication_unregister(
...
** SQLITE_ENABLE_WAL_REPLICATION compile-time option is used.
**/
SQLITE_API SQLITE_EXPERIMENTAL int sqlite3_wal_replication_enabled(
  sqlite3 *db,                            /* Database handle */
...
** SQLITE_ENABLE_WAL_REPLICATION compile-time option is used.
*/
SQLITE_API SQLITE_EXPERIMENTAL int sqlite3_wal_replication_leader(
  sqlite3 *db,                /* Database handle */
  const char *zSchema,        /* Name of attached database (or NULL) */
...
** SQLITE_ENABLE_WAL_REPLICATION compile-time option is used.
*/
SQLITE_API SQLITE_EXPERIMENTAL int sqlite3_wal_replication_follower(
  sqlite3 *db,                      /* Database handle */
  const char *zSchema               /* Name of attached database (or NULL) */
);
...
** SQLITE_ENABLE_WAL_REPLICATION compile-time option is used.
*/
SQLITE_API SQLITE_EXPERIMENTAL int sqlite3_wal_replication_none(
  sqlite3 *db,                      /* Database handle */
  const char *zSchema               /* Name of attached database (or NULL) */
);
...
** SQLITE_ENABLE_WAL_REPLICATION compile-time option is used.
*/
SQLITE_API SQLITE_EXPERIMENTAL int sqlite3_wal_replication_frames(
  sqlite3 *db,         /* Database handle */
  const char *zSchema, /* Name of attached database (or NULL) */
...
** SQLITE_ENABLE_WAL_REPLICATION compile-time option is used.
*/
SQLITE_API SQLITE_EXPERIMENTAL int sqlite3_wal_replication_undo(
  sqlite3 *db,                      /* Database handle */
  const char *zSchema               /* Name of attached database (or NULL) */
);
...
** SQLITE_ENABLE_WAL_REPLICATION compile-time option is used.
*/
SQLITE_API SQLITE_EXPERIMENTAL int sqlite3_wal_replication_checkpoint(
  sqlite3 *db,                    /* Database handle */
  const char *zSchema,            /* Name of attached database (or NULL) */
